    ...
    return (
        <div className='p-5 md:p-0 xl:flex justify-center items-center mt-40'>
            ...
            <div className='flex justify-center'>
                <img src='./verofy.gif' className='w-9/12  xl:w-9/12 rounded-xl border-2 border-orange-300 align-middle' />
            </div>
            <div className=''>
                <h1 className='ml-10 text-[hsl(0,0%,83%)] font-customFont text-xl font-semibold text-center xl:text-left  mt-10 xl:mt-0'><span className='text-yellow-500'>Verofy</span> Payments</h1>
                <h1 className='ml-10 text-[hsl(0,0%,83%)] font-customFont text-sm font-semibold text-center xl:text-left  mt-10 xl:mt-0'><span className='text-yellow-500'> A project for Verofy Ltd. (Manchester)</span></h1>
